...
public class HttpUtil {
	...
	public static void ajaxStatus(HttpServletResponse response, int status, String tip) {
		try {
			response.setContentType("text/html;charset=" + XikeConstants.CHARSET_STR);
	...
	public static String encodeRetURL(String url, String retParam, String retUrl, Map<String, String> data) {
		...
		retStr.append("=");
		try {
			retStr.append(URLEncoder.encode(retUrl, XikeConstants.CHARSET_STR));
	...
	public static String decodeURL(String url) {
		...
		try {
			retUrl = URLDecoder.decode(url, XikeConstants.CHARSET_STR);
		} catch (UnsupportedEncodingException e) {
			logger.severe("encodeRetURL error." + url);
			e.printStackTrace();
		}
	...
	public static String encodeURL(String url) {
		...
		try {
			retUrl = URLEncoder.encode(url, XikeConstants.CHARSET_STR);
		} catch (UnsupportedEncodingException e) {
			logger.severe("encodeRetURL error." + url);
			e.printStackTrace();
		}
